// Domain enums as const objects — used for Drizzle column defaults and Zod validation.
// Not using pgEnum for flexibility; columns are text with validation at the app layer.
...
export const caseStatus = {
  ...
  AWAITING_INTERLOCUTORY: "AWAITING_INTERLOCUTORY",
