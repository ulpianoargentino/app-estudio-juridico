  ...
  cases: {
    ...
    subCases: {
      ...
      form: {
        ...
        type: "Tipo",
        typeNone: "(sin tipo)",
        typeHelp: "Si elegís un tipo, te sugerimos el próximo número (A=Prueba, I=Incidente, X=Otro)",
        number: "Número",
        numberHelpNoType: "Texto libre. Ej: A1, I1, anexo-3.",
        caseTitle: "Carátula",
        caseTitleHelp: "Por defecto se hereda la del padre. Podés editarla.",
        description: "Descripción",
